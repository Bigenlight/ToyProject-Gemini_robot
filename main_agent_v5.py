...
CAMERA_NAME = "front_cam" # [New] 사용할 카메라 이름
...
class GeminiBrain(threading.Thread):
    ...
    def _api_call(self):
        ...
        try:
            ...
            1. Identify the 'Green Sphere' (Current End-Effector point site (doesn't has collision)) and the 'Red Cube' (Target).
...
def main():
    ...
    print("🦾 [System] 에이전트 시작. (초기 위치 대기 중)")
    ...
    with mujoco.viewer.launch_passive(model, data) as viewer:
        ...
        while viewer.is_running():
            ...
            if not brain.is_thinking and (now - last_think_time > 4.0):
                ...
                # [수정] scene.xml에 정의한 'fixed_cam'으로 찰칵!
                try:
                    ...
                    print(f"❌ 카메라 '{CAMERA_NAME}'를 찾을 수 없습니다. scene.xml을 확인하세요!")
                    last_think_time = now + 10 # 에러 시 10초 대기
